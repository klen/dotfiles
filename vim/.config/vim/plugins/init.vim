...
" -----------------------
source $HOME/.config/vim/plugins/nerd.vim
...
" Python support
source $HOME/.config/vim/plugins/pymode.vim
...
" Run tests
source $HOME/.config/vim/plugins/vim-test.vim
...
" Git Support
" -----------
source $HOME/.config/vim/plugins/fugitive.vim

Plug 'rhysd/git-messenger.vim', {'on': ['GitMessenger']}
nnoremap <leader>gm :GitMessenger<CR>

" Snippets
source $HOME/.config/vim/plugins/vsnip.vim

" Diagnostic
source $HOME/.config/vim/plugins/neomake.vim
