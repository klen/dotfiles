...
Premature abstraction creates confusing, hard-to-maintain code.
Duplication is far cheaper to fix than unwinding a wrong abstraction.

## The Rule of Three

Don't abstract until code appears in **at least 3 places**.
This provides enough context to identify genuine patterns vs coincidental similarities.
...
Facades wrap complex subsystems behind a simple interface.
They're useful but often become wrong abstractions when overused.
