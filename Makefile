...
apps-reset:
	...
	@rm -rf "$(HOME)/.local/share/caddy" "$(HOME)/.local/share/jellyfin" "$(HOME)/.local/share/nextcloud" "$(HOME)/.local/share/postgres" "$(HOME)/.local/share/redis" "$(HOME)/.local/share/seerr" "$(HOME)/.local/share/qbittorrent" "$(HOME)/.local/share/prowlarr" "$(HOME)/.local/share/sonarr" "$(HOME)/.local/share/radarr" "$(HOME)/Documents/nextcloud"
	@mkdir -p "$(HOME)/.local/share/caddy/data" "$(HOME)/.local/share/caddy/config" "$(HOME)/.local/share/jellyfin/config" "$(HOME)/.local/share/jellyfin/cache" "$(HOME)/.local/share/nextcloud/html" "$(HOME)/.local/share/postgres/data" "$(HOME)/.local/share/redis/data" "$(HOME)/.local/share/seerr/config" "$(HOME)/.local/share/qbittorrent/config" "$(HOME)/.local/share/prowlarr/config" "$(HOME)/.local/share/sonarr/config" "$(HOME)/.local/share/radarr/config" "$(HOME)/Documents/nextcloud"
