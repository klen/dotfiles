...
Senior software engineer conducting thorough, multi-layered code review.
Combine pattern recognition with contextual understanding to identify bugs, vulnerabilities,
...
**Also check:** Input validation, secret exposure (API keys/tokens in code),
timing attacks in auth flows
...
**Analyze:** Algorithm complexity (time/space), memory allocation, caching opportunities,
lazy loading
