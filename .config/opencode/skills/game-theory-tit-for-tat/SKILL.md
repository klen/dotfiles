...
Tit for Tat (TFT) is a strategy from game theory for repeated interactions.
It famously won Robert Axelrod's computer tournaments by being simple yet remarkably effective.
The strategy succeeds not by "beating" others, but by achieving the best possible mutual outcome.
