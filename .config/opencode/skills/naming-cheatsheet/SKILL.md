...
Comprehensive guidelines for naming variables and functions in any programming language,
based on the A/HC/LC pattern.
...
Accesses data immediately (shorthand getter).
Also used for async operations.
