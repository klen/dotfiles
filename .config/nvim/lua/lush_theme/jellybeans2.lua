...
local theme = lush(function()
  return {
    ...
    LspDiagnosticsSignError              { fg=old_brick.lighten(10)  }, -- Used for "Error" signs in sign column
    LspDiagnosticsSignWarning            { fg=goldenrod.darken(40) }, -- Used for "Warning" signs in sign column
    LspDiagnosticsSignInformation        { fg=ship_cove }, -- Used for "Information" signs in sign column
    LspDiagnosticsSignHint               { fg=morning_glory.darken(40) }, -- Used for "Hint" signs in sign column

    LspDiagnosticsVirtualTextError       { LspDiagnosticsSignError }, -- Used for "Error" diagnostic virtual text
    LspDiagnosticsVirtualTextWarning     { LspDiagnosticsSignWarning }, -- Used for "Warning" diagnostic virtual text
    LspDiagnosticsVirtualTextInformation { LspDiagnosticsSignInformation }, -- Used for "Information" diagnostic virtual text
    LspDiagnosticsVirtualTextHint        { LspDiagnosticsSignHint }, -- Used for "Hint" diagnostic virtual text

    LspDiagnosticsUnderlineError         { gui='none' }, -- Used to underline "Error" diagnostics
    LspDiagnosticsUnderlineWarning       { gui='none' }, -- Used to underline "Warning" diagnostics
    LspDiagnosticsUnderlineInformation   { gui='none' }, -- Used to underline "Information" diagnostics
    LspDiagnosticsUnderlineHint          { gui='none', guisp=old_brick }, -- Used to underline "Hint" diagnostics
