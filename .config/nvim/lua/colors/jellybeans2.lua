...
local theme = lush(function()
  return {
    ...
    DiagnosticUnderlineInfo { gui = "none" }, -- Used to underline "Information" diagnostics
    DiagnosticUnderlineHint { gui = "none", guisp = old_brick }, -- Used to underline "Hint" diagnostics
